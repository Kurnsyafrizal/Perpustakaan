...
if(isset($_POST['submit_admin'])){
  ...
  if($cek==1){
    ...
    $simpans = mysqli_query($koneksi, $data);
      ...
      document.location="?hal=admin/daftaruser/list";
      </script>';
    }else{
  ...
  if($ton){
      ...
      location.href="?hal=admin/daftaruser/list";</script> ';
      exit;
  }else {
...
<div class="container">
        ...
        <button type="button" class="btn  show-modal" data-toggle="modal">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" name="submit_admin" value="Simpan" class="btn">
      </div>
      </form>
    </div>
  </div>
...
<div class="row justify-content-md-center">
  ...
  <tr>
    ...
    <tr>
      ...
      <td>
      <a href="?hal=admin/daftaruser/edit&id=<?php echo $d['id'];  ?>" >
      <button class="btn ">
      Edit
      </button>
      </a>
          <a href="?hal=admin/daftaruser/list&hapus=<?php echo $d['id'];  ?>">
