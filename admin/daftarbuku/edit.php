...
// melakukan pengambilan data dari tabel buku
$id = $_GET['id'];
...
// untuk mengatur semua perubahan yang terjadi pada edit buku
if(isset($_POST['simpan'])){ //isset untuk mengambil name value dalam satu form
    $ids = $_POST['kode_buku'];
    ...
    if($el && $har){
        ...
        location.href="?hal=admin/daftarbuku/list"
        </script> ';
    }
