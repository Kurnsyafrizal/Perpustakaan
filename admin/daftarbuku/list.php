...
if(isset($_POST['tambah_buku'])){
    ...
    if($khalid && $basalamah){
        ...
        location.href="?hal=admin/daftarbuku/list";</script> ';
...
<div class="col-md-12 main-content">
    ...
    <div class="row">
        <div class="col-md-5">
            <button type="button" class="btn" data-toggle="modal" data-target="#modalsatu" >
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <input class="btn " type="submit" name="tambah_buku" value="Tambah">
                        </div>
                    </div>
                    </form>
                </div>
...
// Mengambil Id buku dari database
      ...
      ?>
    <tr>
<!-- Mengambil dan menampilkan data yang telah di input dari database -->
      <th scope="row"><?= $no++; ?></th>
      <td><?= $d['kode_buku'] ?></td>
      <td><?= $d['judul_buku'] ?></td>
      <td><?= $d['pengarang'] ?></td>
      ...
      <td>
          <div class="btn-group">
              <a href="?hal=admin/daftarbuku/edit&id=<?= $d['kode_buku'] ?>">
              <button class="btn " type="submit">
              Edit
              </button>  
              </a>
              <a href="?hal=admin/daftarbuku/list&hapus=<?= $d['kode_buku'] ?>">
                <button class="btn " type="submit" name="hapus">
                    Hapus
                </button>
              </a>
          </div>
